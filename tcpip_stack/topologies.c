...
graph_t   *build_first_topo(void)
{
  ...
  node_set_intf_ip_address(R0_re, "eth0/1", "20.1.1.2", 24);
  node_set_intf_ip_address(R0_re, "eth0/2", "30.1.1.1", 24);
  
  node_set_device_type(R0_re, L3_ROUTER);
  node_set_loopback_address(R0_re, "122.1.1.2");
  node_set_intf_ip_address(R0_re, "eth0/3", "30.1.1.2", 24);
  node_set_intf_ip_address(R0_re, "eth0/5", "40.1.1.2", 24);
